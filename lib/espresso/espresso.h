...
// #define PTIME(t)    util_PTIME(t)
#define PTIME()		    0
#define PRINT_TIME(t)	0
...
#define ESPRESSO_TWO     3
#define ESPRESSO_DASH    3
#define ESPRESSO_ONE     2
#define ESPRESSO_ZERO    1
...
/* cubehack.c */ extern void define_cube_size( int n );
